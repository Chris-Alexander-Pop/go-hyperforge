...
// ResilientConfig configures the resilient push sender wrapper.
type ResilientConfig struct {
	CircuitBreakerEnabled   bool          `env:"PUSH_CB_ENABLED" env-default:"false"`
	CircuitBreakerThreshold int64         `env:"PUSH_CB_THRESHOLD" env-default:"5"`
	CircuitBreakerTimeout   time.Duration `env:"PUSH_CB_TIMEOUT" env-default:"30s"`

	RetryEnabled     bool          `env:"PUSH_RETRY_ENABLED" env-default:"true"`
	RetryMaxAttempts int           `env:"PUSH_RETRY_MAX" env-default:"3"`
...
// ResilientConfigFrom maps push.Config retry fields into a ResilientConfig.
...
// Send dispatches a single push notification with retry/circuit-breaker protection.
...
// SendBatch dispatches multiple push notifications with retry/circuit-breaker protection.
