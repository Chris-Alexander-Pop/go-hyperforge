...
// ResilientConfig configures the resilient chat sender wrapper.
type ResilientConfig struct {
	CircuitBreakerEnabled   bool          `env:"CHAT_CB_ENABLED" env-default:"false"`
	CircuitBreakerThreshold int64         `env:"CHAT_CB_THRESHOLD" env-default:"5"`
	CircuitBreakerTimeout   time.Duration `env:"CHAT_CB_TIMEOUT" env-default:"30s"`

	RetryEnabled     bool          `env:"CHAT_RETRY_ENABLED" env-default:"true"`
	RetryMaxAttempts int           `env:"CHAT_RETRY_MAX" env-default:"3"`
...
// ResilientConfigFrom maps chat.Config retry fields into a ResilientConfig.
...
// Send dispatches a single chat message with retry/circuit-breaker protection.
