...
// Usage:
//
//	import "github.com/chris-alexander-pop/go-hyperforge/pkg/ai/ml/training/adapters/pytorch"
//
...
func New(cfg Config) *Trainer {
	...
	return &Trainer{
		...
		mu:       concurrency.NewSmartRWMutex(concurrency.MutexConfig{Name: "ml-training-pytorch"}),
	}
}
