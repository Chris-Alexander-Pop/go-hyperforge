...
This repo is a **Go library SDK** (`go-hyperforge` / module `github.com/chris-alexander-pop/go-hyperforge`), not a runnable multi-service app. Default quality gates use in-memory adapters and do not require Docker.
